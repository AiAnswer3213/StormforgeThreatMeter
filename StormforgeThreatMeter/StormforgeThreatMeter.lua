...
meter.title:SetJustifyH("RIGHT")
meter.title:SetTextColor(1, 0.549, 0, 0.8)
meter.title:SetShadowColor(0, 0, 0, 1)
meter.title:SetShadowOffset(1, -1)
meter.title:SetText("/stm")

--resize button
meter.resizeButton = CreateFrame("Button", nil, meter)
meter.resizeButton:SetWidth(8 / scale)
meter.resizeButton:SetHeight(8 / scale)
...
meter.resizeButton:SetAlpha(0.5)
